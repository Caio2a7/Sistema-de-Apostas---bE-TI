...
SOURCES = $(wildcard $(ENTITIDIR)/*.cpp) $(wildcard $(CLISRC)/*.cpp) $(wildcard $(DBCONFIGDIR)/*.cpp)  $(wildcard $(REPOSITORYDIR)/*.cpp)  $(wildcard $(SERVICEDIR)/*.cpp) $(wildcard $(ENUMDIR)/*.cpp) $(wildcard $(SRCDIR)/*.cpp)
